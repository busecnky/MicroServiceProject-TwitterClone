...
//    public ResponseEntity<Page<Post>> findallPageByUsername(@RequestParam(defaultValue = "10")Integer pageSize,
//                                                            @RequestParam(defaultValue = "0")Integer pageNumber,
//                                                            @RequestParam(defaultValue = "DESC") String direction,
//                                                            @RequestParam(defaultValue = "userId") String sortParameter,
//                                                            String token){
//
//        return ResponseEntity.ok(postService.findAllByUserId(pageSize,pageNumber,direction,sortParameter
//                                ,token));
//    }
