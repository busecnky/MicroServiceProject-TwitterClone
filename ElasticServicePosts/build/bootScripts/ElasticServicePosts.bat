...
set JARPATH=%APP_HOME%\lib\ElasticServicePosts-v.0.1.jar

@rem Execute ElasticServicePosts
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ELASTİC_SERVİCE_POSTS_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ELASTİC_SERVİCE_POSTS_EXIT_CONSOLE%" exit 1
exit /b 1
